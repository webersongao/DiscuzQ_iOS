...
-(UIButton *)bottomBar{
    if (!_bottomBar) {
        _bottomBar = [UIButton ButtonTextWithFrame:CGRectMake(0, 0, 0, 0) titleStr:@"" titleColor:KGreen_Color titleTouColor:KGreen_Color font:KFont(15.f) Radius:0 Target:self action:nil];
    }
    return _bottomBar;
}
