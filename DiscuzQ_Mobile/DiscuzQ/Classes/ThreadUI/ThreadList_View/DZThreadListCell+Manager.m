...
-(void)moreButtonAction:(UIButton *)button{
    ...
    [DZThreadHelper thread_MoreCellAction:postModel sender:button];
...
-(void)likeButtonAction:(UIButton *)button{
    ...
    [DZThreadHelper thread_LikeCellAction:postModel];
...
-(void)replyButtonAction:(UIButton *)button{
    ...
    [DZThreadHelper thread_CommentCellAction:postModel];
...
-(void)shareButtonAction:(UIButton *)button{
    ...
    DZQPostModel *postModel = [self barData];
    [DZThreadHelper thread_SharedCellAction:postModel];
}
