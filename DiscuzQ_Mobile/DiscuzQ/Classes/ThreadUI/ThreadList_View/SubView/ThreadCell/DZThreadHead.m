...
- (UILabel *)timeLabel{
    if (!_timeLabel) {
        _timeLabel = [UILabel labelWithFrame:CGRectZero title:@"" titleColor:KColor(K2A2C2F_Color, 1.0) font:KFont(12.f) textAlignment:NSTextAlignmentLeft];
    }
    return _timeLabel;
}
...
-(UIButton *)moreButton{
    if (!_moreButton) {
       _moreButton = [UIButton ButtonNormalWithFrame:CGRectZero title:@"" titleFont:nil titleColor:nil normalImgPath:@"dz_list_more" touchImgPath:@"dz_list_more" isBackImage:YES];
    }
    return _moreButton;
}
