...
- (UIButton *)moreButton{
    if (!_moreButton) {
        _moreButton = [UIButton ButtonNormalWithFrame:CGRectZero title:@"" titleFont:nil titleColor:nil normalImgPath:@"dz_logo_banCircle" touchImgPath:@"dz_logo_banCircle" isBackImage:YES picAlpha:1];
    }
    return _moreButton;
}
