...
@implementation DZDataHelper (EmojiM)

- (void)databaseCreateForEmoji:(FMDatabase *)database{
    
    [database executeUpdate:@"DROP TABLE IF EXISTS \"DQ_SiteEmojiTable\";"];
    [database executeUpdate:@"CREATE TABLE \"DQ_SiteEmojiTable\" (\n"
