...
@interface DZSiteManageM : NSObject
...
@interface DZSiteAuthorM : NSObject
...
@interface DZSitePivotM : NSObject
...
@interface DZSiteGroupM : NSObject
...
@property (nonatomic, strong) DZSitePivotM *pivot;  //!< 属性注释
