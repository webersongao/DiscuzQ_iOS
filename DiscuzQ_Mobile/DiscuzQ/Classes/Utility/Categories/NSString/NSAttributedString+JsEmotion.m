//
//  NSAttributedString+JsEmotion.m
//  Jinsanjiao
//
//  Created by WebersonGao on 2018/5/18.
...
- (NSMutableAttributedString *)emotionFontsize:(CGFloat)fontSize {
    // 匹配 [表情]
    NSArray<NSTextCheckingResult *> *emoticonResults = [[WBStatusHelper regexEmoticon] matchesInString:self.string options:kNilOptions range:self.yy_rangeOfAll];
