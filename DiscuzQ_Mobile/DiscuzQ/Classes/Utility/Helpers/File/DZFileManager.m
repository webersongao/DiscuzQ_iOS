...
- (CGFloat)filePathSize {
    ...
    NSString *path = [DZCacheManager sharedInstance].DZQKitPath;
...
- (NSString *)cacheFilename:(NSString*)fileName{
    NSString *filename = [[DZCacheManager sharedInstance].DZQKitPath stringByAppendingPathComponent:fileName];
    return filename;
}
/**
 * 返回Document 目录
