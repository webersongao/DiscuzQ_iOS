...
- (void)_setupUI
{
    ...
    updateIcon.image = [UIImage imageNamed:@"dz_VerUp_Icon"];
    ...
    [cancelButton setImage:[[UIImage imageNamed:@"dz_VerUp_Cancel"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
...
- (void)updateVersion
{
    NSString *updatePath = DZ_AppUpdatepath;
    [[UIApplication sharedApplication] openURL:KURLString(updatePath) options:nil completionHandler:nil];
}
