...
@interface DZEqualLayoutTool(){
    //在居中对齐的时候需要知道这行所有cell的宽度总和
    CGFloat _sumCellWidth ;
}
@end

@implementation DZEqualLayoutTool
-(instancetype)init{
    return [self initWithAlignType:AlignWithCenter betweenOfCell:5.0];
}
...
-(instancetype)initWthType:(AlignType)cellType{
    return [self initWithAlignType:cellType betweenOfCell:5.0];
}
