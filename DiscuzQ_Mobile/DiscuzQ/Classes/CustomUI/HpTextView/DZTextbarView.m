...
- (UIButton *)shareBtn {
    if (_shareBtn == nil) {
        ...
        [_shareBtn setBackgroundImage:[UIImage imageNamed:@"navi_bar_fen"] forState:UIControlStateNormal];
...
- (UIButton *)addBtn {
    ...
    if (_addBtn == nil) {
        ...
        [_addBtn setBackgroundImage:[UIImage imageNamed:@"navi_add_attachment"] forState:UIControlStateNormal];
    }
