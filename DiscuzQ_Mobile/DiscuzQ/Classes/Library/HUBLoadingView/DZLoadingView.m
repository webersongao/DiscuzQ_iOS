...
@property (nonatomic, strong) DZLoadingView *actingView;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    {
        _actingView = [[DZLoadingView alloc] initWithActImageView];
        ...
        m_textLabel.textColor = KDarkGreen_Color;
