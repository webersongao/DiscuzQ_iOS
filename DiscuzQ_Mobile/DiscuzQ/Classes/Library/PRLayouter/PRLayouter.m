...
//  DiscuzQ
//
//  Created by Perfect on 2017/11/9.
//
...
@property (nonatomic, assign) CGFloat dzClientNavigationHeight;
@property (nonatomic, assign) CGFloat dzClientNavigationHeightContainsStatusBar;
// 正常导航栏应该是20 + 44与44 + 44；而dzClient是20 + 44与20 + 68；因此导航栏内部控件的偏移量，应该是(44 - 20) = 24
@property (nonatomic, assign) CGFloat dzClientNavigationGap2X;
@property (nonatomic, assign) CGFloat dzClientNavigationGapX;

// 强制竖屏版
@property (nonatomic, assign) CGFloat dzClientNavigationHeightForcePortrait;
@property (nonatomic, assign) CGFloat dzClientNavigationHeightContainsStatusBarForcePortrait;
@property (nonatomic, assign) CGFloat dzClientNavigationGap2XForcePortrait;
@property (nonatomic, assign) CGFloat dzClientNavigationGapXForcePortrait;

@property (nonatomic, assign) CGFloat dzClientTabBarHeight;
// 仅仅避过homeBar，而不用避过圆角
@property (nonatomic, assign) CGFloat dzClientBottomBarHeight;
...
{
    return _instance.dzClientNavigationHeight;
}

+ (CGFloat)navigation_Bar_ContainStatusBar_Height
{
    return _instance.dzClientNavigationHeightContainsStatusBar;
}

+ (CGFloat)navigation_Bar_Gap_X
{
    return _instance.dzClientNavigationGapX;
}

+ (CGFloat)navigation_Bar_Gap_2X
{
    return _instance.dzClientNavigationGap2X;
}

+ (CGFloat)navigation_Bar_Height_Portrait
{
    return _instance.dzClientNavigationHeightForcePortrait;
}

+ (CGFloat)navigation_Bar_ContainStatusBar_Height_Portrait
{
    return _instance.dzClientNavigationHeightContainsStatusBarForcePortrait;
}

+ (CGFloat)navigation_Bar_Gap_X_Portrait
{
    return _instance.dzClientNavigationGapXForcePortrait;
}

+ (CGFloat)navigation_Bar_Gap_2X_Portrait
{
    return _instance.dzClientNavigationGap2XForcePortrait;
}

+ (CGFloat)tabbar_Height
{
    return _instance.dzClientTabBarHeight;
}
...
{
    return _instance.dzClientBottomBarHeight;
}
...
- (void)updateDeviceSafeInsets
{
    if ([self isIphoneX]) {
        if (self.isPortrait) { // 竖屏
            ...
            _dzClientNavigationHeight = 68;
            _dzClientNavigationHeightContainsStatusBar = 88;
            _dzClientNavigationGap2X = 44 - 20;
        } else { // 横屏
            ...
            _dzClientNavigationHeight = 44;
            _dzClientNavigationHeightContainsStatusBar = 64;
            _dzClientNavigationGap2X = 0;
        }
        
        _dzClientNavigationHeightForcePortrait = 44;
        _dzClientNavigationHeightContainsStatusBarForcePortrait = 88;
        _dzClientNavigationGap2XForcePortrait = 44 - 20;
        _screenBottomGap = 21;
        ...
        _dzClientNavigationHeightForcePortrait = 44;
        _dzClientNavigationHeightContainsStatusBarForcePortrait = 64;
        _dzClientNavigationGap2XForcePortrait = 0;
        _screenBottomGap = 0;
        _statusBarHeight = 20.f;
    }
    
    _dzClientNavigationGapX = _dzClientNavigationGap2X * 0.5;
    _dzClientNavigationGapXForcePortrait = _dzClientNavigationGap2XForcePortrait * 0.5;
    _dzClientTabBarHeight = 49 + _screenSafeInsetsBottom;
    _dzClientBottomBarHeight = 49 + _screenBottomGap;
}
