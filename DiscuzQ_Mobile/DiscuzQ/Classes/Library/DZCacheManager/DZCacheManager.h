...
@interface DZCacheManager : NSObject


//返回单例对象
+ (DZCacheManager *)sharedInstance;
...
/**
 ...
 @return Library/Caches/DZKit/AppCache路径
 */
- (NSString *)DZQAppCachePath;
...
/**
 *  查找存储的文件         默认缓存路径/Library/Caches/DZKit/AppCache
 *  @param  key         存储的文件
 *
...
/**
 * 显示data文件缓存大小 默认缓存路径/Library/Caches/DZKit/AppCache
 * Get the size used by the disk cache
 */
- (NSUInteger)getCacheSize;

/**
 * 显示data文件缓存个数 默认缓存路径/Library/Caches/DZKit/AppCache
...
/**
 *  设置过期时间 清除路径下的全部过期缓存文件 默认路径/Library/Caches/DZKit/AppCache
...
/**
 *  清除某一个缓存文件      默认路径/Library/Caches/DZKit/AppCache
 *  @param key          请求的协议地址
 */
...
/**
 *  设置过期时间 清除某一个缓存文件  默认路径/Library/Caches/DZKit/AppCache
 *  @param key          请求的协议地址
...
/**
 *  清除磁盘缓存 /Library/Caches/DZKit/AppCache
