...
@interface DZQCashModel : DZQSuperAttribute
...
@property (nonatomic, strong) DZQCashModel *attributes;    //!< 属性注释
@property (nonatomic, strong) DZQCashRelationModel *relationships;  //!< 属性注释
