...
@interface DZSiteManageV3 : NSObject
...
@interface DZSiteAuthorV3 : NSObject
...
@interface DZSitePivotV3 : NSObject
...
@interface DZSiteGroupV3 : NSObject
...
@property (nonatomic, strong) DZSitePivotV3 *pivot;  //!< 属性注释
