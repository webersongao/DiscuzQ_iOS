...
@interface DZQCashLogV1 : DZQSuperAttribute
...
@property (nonatomic, strong) DZQCashLogV1 *attributes;    //!< 属性注释
@property (nonatomic, strong) DZQCashLogRelationV1 *relationships;  //!< 属性注释
