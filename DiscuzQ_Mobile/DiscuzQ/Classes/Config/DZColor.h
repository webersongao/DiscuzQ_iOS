...
/// 以下为经常使用的说明色
#define K33C3A5_Color  @"#33C3A5"  // 195 绿色 -- 淡
#define K00BF99_Color  @"#00BF99"  // 191 绿色 -- 深
#define KFD8230_Color  @"#FD8230"  // 高亮色（橙黄）
#define KE3170D_Color  @"#E3170D"  // 暗红色

#define K000000_Color  @"#000000"  // 0 纯黑
#define K2A2C2F_Color  @"#2A2C2F"  // 44 tabbar 标题黑色
#define K31323E_Color  @"#31323E"  // 50 深黑
#define K4D5663_Color  @"#4D5663"  // 86 黑灰阴影色
#define K6A6C7A_Color  @"#6A6C7A"  // 108 灰色 -- 灰色
#define K9A9AA7_Color  @"#9A9AA7"  // 154 灰色
#define KBDC0C6_Color  @"#BDC0C6"  // 192 灰色 -- 按钮禁用
#define KE2E2E5_Color  @"#E2E2E5"  // 226 浅灰色 分割线(仅限导航条底部使用)
#define KF5F5F5_Color  @"#F5F5F5"  // 245 灰白色 （接近于白色）
#define KF9F9F9_Color  @"#F9F9F9"  // 249 浅灰白
#define KFFFFFF_Color  @"#FFFFFF"  // 255 纯白色
...
#define KGray_Color          KColor(K9A9AA7_Color, 1.0) // 浅灰色正文  灰色图标
#define KLightGray_Color     KColor(KF5F5F5_Color, 1.0) // 245 灰白色 （接近于白色）
...
#define KLightLine_Color     KColor(KF9F9F9_Color, 1.0) // 249


#define KNormal_fontSize     14  // 常用字号
#define KDesc_fontSize     12  // 描述性文字 字号

#define KTitle_fontSize      14  // 标题 字号
#define KContent_fontSize    14  // 正文内容 字号
#define KBoldTile_fontSize    17  // 正文内容 字号
...
#define KAlphaColor(colName,alphaV)   [UIColor color16WithHexString:colName.hexString alpha:alphaV]
