...
- (void)setParentControl:(UIViewController *)parentController {
    ...
    ForumThreadController *bdVC = (ForumThreadController *)self.parentController;
...
- (void)setChildCanScroll:(BOOL)childCanScroll {
    //修改所有的子控制器的状态
    for (ForumListBaseCtrl *ctrl in self.viewControllers) {
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    [(ForumThreadController *)self.parentController setSelectIndex:index];
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    [(ForumThreadController *)self.parentController setScrollEnable:NO];
}

- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset {
    
    [(ForumThreadController *)self.parentController setScrollEnable:YES];
}
