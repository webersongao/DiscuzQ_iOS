...
#import "DZQChatMapCell.h"

@implementation DZQChatMapCell
...
-(void)mapButtonPressed:(UIButton *)sendeer{
    if(self.cellDelegate && [self.cellDelegate respondsToSelector:@selector(DZQChatCellLocationClick:layout:)]){
        [self.cellDelegate DZQChatCellLocationClick:self.indexPath layout:self.layout];
    }
}
