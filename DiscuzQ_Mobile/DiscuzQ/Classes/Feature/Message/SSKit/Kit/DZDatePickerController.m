...
#import "DZDatePickerController.h"
...
-(instancetype)initWithFrame:(CGRect)frame{
    if(self = [super initWithFrame:frame]){
        ...
        _mTitleLab.frame = makeRect(0, 0, SS_DZDatePickerViewW, 50);
        ...
        UIView *line = [[UIView alloc]initWithFrame:makeRect(0, _mTitleLab.bottom-0.5, SS_DZDatePickerViewW, 0.5)];
        ...
        [_mBackBtn setTitleColor:KGreen_Color forState:UIControlStateNormal];
        ...
        [_mOKBtn setTitleColor:KGreen_Color forState:UIControlStateNormal];
        ...
        line2.backgroundColor = KLine_Color;
        [self addSubview:line2];
     
        
        UIView *line3 = [[UIView alloc]initWithFrame:makeRect(0, _mOKBtn.top, SS_DZDatePickerViewW, 0.5)];
        line3.backgroundColor = KLine_Color;
        [self addSubview:line3];
        
        
        _datePicker = [[UIDatePicker alloc] init];
        _datePicker.frame = makeRect(0, 45, SS_DZDatePickerViewW, SS_DZDatePickerViewH-_mTitleLab.height-_mBackBtn.height);
...
-(void)buttonPressed:(UIButton *)sender{
    if(_delegate && [_delegate respondsToSelector:@selector(DZDatePickerViewBtnClick:date:)]){
        [_delegate DZDatePickerViewBtnClick:sender.tag date:_timeString];
    }
...
//时间选择器的控制器
@interface DZDatePickerController ()<DZDatePickerViewDelegate>

@end

@implementation DZDatePickerController
...
- (void)viewDidLoad {
    ...
    _datePickerView = [[DZDatePickerView alloc]initWithFrame:makeRect(0, 0, SS_DZDatePickerViewW, SS_DZDatePickerViewH)];
    _datePickerView.delegate = self;
    _datePickerView.centerY = kScreenHeight*0.5;
    _datePickerView.centerX = kScreenWidth*0.5;
...
#pragma DZDatePickerViewDelegate 返回10  确定11
