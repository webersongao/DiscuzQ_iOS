...
- (void)initViews {
    ...
    self.messageLabel.textColor = KTitle_Color;
    
}

- (void)setMessageModel:(oldMssageModel *)messageModel {
    _messageModel = messageModel;
    
    CGFloat msgWidth = messageModel.textLayout.textBoundingSize.width;
    
    [self.headView dz_setImageWithURL:self.messageModel.fromavatar placeholder:[UIImage imageNamed:@"noavatar_small"]];
