...
@interface DZSearchViewController ()<UISearchBarDelegate>
...
-(DZSearchToolBar *)searchView{
    if (!_searchView) {
        _searchView = [[DZSearchToolBar alloc] initWithFrame:CGRectMake(0, KStatusBarHeight, self.view.width - kMargin45 - KNavigation_Bar_Height, KNavigation_Bar_Height)];
