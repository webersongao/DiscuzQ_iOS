...
@interface DZGridFlowLayout () <UIGestureRecognizerDelegate>
...
@implementation DZGridFlowLayout
{
...
- (instancetype)initWithWidth:(CGFloat)GridWidth WHScale:(CGFloat)scale
{
    if (self = [super init]) {
        [self setup];
        CGFloat margin = kMargin5;
        CGFloat itemW = (GridWidth - margin*2.0) / 3.0;
        CGFloat itemH = itemW * scale;
        
        self.minimumLineSpacing = (margin -1);
        self.itemSize = CGSizeMake(itemW, itemH);
        self.minimumInteritemSpacing = (margin -1);
    }
    return self;
}
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            DZAttachGridCell *sourceCell = (DZAttachGridCell *)sourceCollectionViewCell;
            ...
            UIView * highlightedSnapshotView = [sourceCell snapshotCellView];
            ...
            UIView * snapshotView = [sourceCell snapshotCellView];
